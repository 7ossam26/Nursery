// Copy for the application shell chrome: appearance, destination search, support navigation,
// breadcrumbs and the signed-in dashboard. Same shape as every features/*/copy.ts module, so
...
export const shellEn = {
  ...
  'shell.back': 'Go back',
  'shell.menu': 'Menu',
  'shell.openSupportMenu': 'Open support menu',
  'shell.closeSupportMenu': 'Close support menu',
...
export const shellAr: Record<keyof typeof shellEn, string> = {
  ...
  'shell.back': 'ارجع للصفحة اللي فاتت',
  'shell.menu': 'القائمة',
  'shell.openSupportMenu': 'افتح قائمة الدعم',
  'shell.closeSupportMenu': 'اقفل قائمة الدعم',
  'shell.breadcrumb': 'مكانك في الموقع',
  'shell.home': 'الرئيسية',
  'home.dashboardTitle': 'الرئيسية',
