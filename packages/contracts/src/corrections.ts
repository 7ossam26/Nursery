...
export type FinancialCorrectionRecord={id:string;targetKind:'RECEIPT'|'EXPENSE'|'TRANSFER'|'TUITION';targetId:string;action:'REVERSAL'|'REPLACEMENT'|'REDUCTION';effectiveOn:string;reason:string;actor:string};
